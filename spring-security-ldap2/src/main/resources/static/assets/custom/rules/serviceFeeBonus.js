var ServiceFeeBonus = function() {
	...
	return {
		...
		edit:function(dmid){
			$.get('/rule/serviceFeeBonus/findone',{id:dmid},function(data,state){
				if (state == "success") {
		...
		remove:function(id,name,token){
			var data={'id':id};
	    	data[name]=token;
	    	var opt={url:'/rule/serviceFeeBonus/remove',type:'POST',data:data};
