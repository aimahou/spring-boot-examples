var ServiceFee = function() {
	...
	return {
		...
		edit:function(dmid){
			$.get('/rule/serviceFee/findone',{id:dmid},function(data,state){
				if (state == "success") {
		...
		remove:function(id,name,token){
			var data={'id':id};
	    	data[name]=token;
	    	var opt={url:'/rule/serviceFee/remove',type:'POST',data:data};
